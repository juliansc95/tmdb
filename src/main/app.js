...
define([ 'angular',
         ...
         'tmdb/directives/movieDetailTwo',
    ...
    function( angular, config, $resource, $location, LocalStorageModule, 
              ...
              RemoteImageLoader,MovieDetailTwoController,MovieTileController, searchDirective, popularMoviesDirective, 
              personDetailDirective, personCrewDirective, personCastDirective,
              movieDetailDirective, similarMoviesDirective, movieCastDirective, movieCrewDirective,movieDetailTwoDirective,movieTileDirective ) {
    	"use strict";
        ...
        app.config(['$routeProvider', function($routeProvider) {
            ...
            $routeProvider.when( '/movie/:id', { templateUrl: '/tmdb/partials/movieDetail/movieDetail.html' } );
